...
class Game {
    ...
    startGame() {
        ...
        for ( let i = 0; i < hearts.length; i++ ) {
            hearts[i].innerHTML = '<img src="imgs/liveHeart.png" alt="Heart Icon" height="35" width="30"></img>';
        };
    ...
    removeLife(array) {
        ...
        for (let i=0; i<array.length; i++) {
            let html = '<img src="imgs/lostHeart.png" alt="Heart Icon" height="35" width="30"></img>';

            if (array[i].innerHTML.includes('imgs/liveHeart.png')) {
